...
## پنج دامی که بسته شده‌اند

سه‌تای اول از مستنداتِ اپل آمدند. دوتای آخر را **خودِ اپل سرِ اولین
ارسالِ واقعی یاد داد** و هر دو از یک جنس‌اند: چیزی که شبیهِ موفقیت
است.
