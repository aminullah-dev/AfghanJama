...
NOT_YET = {
    # «برش» و «حضور و غیاب» از این فهرست بیرون رفتند: هر دو به
    # `commonMain` آمدند و حالا روی آیفون هم باز می‌شوند. خودِ همین
    # بررسی بود که سرِ ادغام گرفتشان — پیامِ «هنوز نیامده» دروغ شده
    # بود و کسی متوجه نمی‌شد.
