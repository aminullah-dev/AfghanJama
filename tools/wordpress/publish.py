#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# `dict | None` در حاشیه‌نویسی‌ها نحوِ پایتون ۳٫۱۰ است، ولی پایتونی که
# روی مکِ خودِ کارفرما `python3` صدا زده می‌شود ۳٫۹ است — یعنی این
# فایل همان‌جا که قرار بود اجرا شود، سرِ ایمپورت می‌مرد:
#
#     TypeError: unsupported operand type(s) for |: 'type' and 'NoneType'
#
# این خط حاشیه‌نویسی‌ها را به رشته تبدیل می‌کند (از ۳٫۷ به بعد)، پس
# هم نحوِ تازه می‌مانَد هم روی ۳٫۹ می‌دود.
