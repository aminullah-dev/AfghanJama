...
object Brand {
    ...
    val CopperLight = Color(0xFFEBCBA6)

    /** باریکهٔ بازتاب — همان چیزی که سطح را صیقلی نشان می‌دهد. */
    val CopperSheen = Color(0xFFDFB68C)

    /** مسِ پایه. */
    val Copper = Color(0xFFC08B57)

    /** تیره‌ترین پله — لبهٔ پایینی. */
    val CopperDeep = Color(0xFF97633A)

    /**
     * متنی که روی مس می‌نشیند.
     *
     * قهوه‌ایِ بسیار تیره، نه سیاهِ خالص: روی زمینهٔ گرم، سیاهِ خالص
     * سرد و بریده به نظر می‌رسد. نسبتِ کنتراستش با [Copper] بالای ۷
     * است، یعنی از حدِ AAAی متنِ درشت هم می‌گذرد.
     */
    val OnCopper = Color(0xFF3B2413)

    /** همان متن، کم‌رنگ‌تر — برای زیرنویس روی مس. */
    val OnCopperMuted = Color(0xFF6B4A2E)
