...
object CashPolicy {
    ...
    /**
     * دستهٔ سطرهایی که پول را بینِ صندوق‌های **خودِ کارگاه** جابه‌جا
     * می‌کنند — نه درآمد، نه هزینه.
     *
     * سه مسیر این کار را می‌کنند و هر سه یک جفت سطرِ IN/OUT می‌نویسند:
     * انتقالِ سودِ فروش به «فایده»، برگشتش هنگامِ برگشتِ فروش، و انتقالِ
     * دستیِ بینِ صندوق‌ها. بی این برچسب، گزارشِ «جریان نقد» سودِ هر فروش
     * را هم ورودیِ نقد می‌شمرد و هم خروجیِ نقد، و مبلغش را زیرِ دستهٔ
     * «سایر» به‌عنوان هزینه نشان می‌داد.
     */
    const val INTERNAL_MOVE = "انتقال داخلی"

    /** آیا این سطر جابه‌جاییِ داخلی است؟ در گزارشِ نقد نباید شمرده شود. */
    fun isInternalMove(category: String): Boolean = category == INTERNAL_MOVE
