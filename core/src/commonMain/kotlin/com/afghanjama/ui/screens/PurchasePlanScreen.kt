...
private fun Double.qty(): String {
    val r = (this * 100.0).roundToLong() / 100.0
            ...
            if (!ui.hasData) {
                item {
                    EmptyState(
                        ...
                        // تا امروز این جمله بن‌بست بود: می‌گفت کجا برو و
                        // راهی به آنجا نمی‌داد. دکمه‌اش از قبل در همین
                        // صفحه بود، فقط پایین‌تر و مشروط به داشتنِ داده.
                        actionLabel = "رفتن به خرید مواد",
                        onAction = onGoProcurement
                    )
                }
            }
