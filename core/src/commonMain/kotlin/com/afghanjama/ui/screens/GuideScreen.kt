        ...
        LazyColumn(
            ...
            item {
                GuideCard(
                    ...
                    title = "روزِ اول",
                    lines = listOf(
                        "کارگاهِ تازه با «کارگاهِ نمونه» شروع می‌کند: طرح، پارچه، رنگ، سایز، خرجِ کار، خیاط، کارمند و مشتری از قبل آماده‌اند.",
                        "همه را از آنِ خودتان کنید: اطلاعات پایه، «حقوق کارکنان» ← ویرایش، و پروندهٔ هر مشتری ← آیکنِ مداد.",
                        "بعد تنظیمات ← «پاک‌کردن کارها و حساب‌ها»: سفارش‌ها، پول و انبارِ نمونه می‌روند؛ آنچه شخصی کردید می‌ماند.",
                        "انبار مواد: آنچه همین حالا دارید، با تعداد و قیمت.",
                        "ساختنِ دوبارهٔ کارگاهِ نمونه قفل است و رمزِ ورود می‌خواهد — کارگاه را به نمونه برنمی‌گرداند، دادهٔ ساختگی را روی کارِ واقعی اضافه می‌کند."
                    )
                )
            }
            ...
            item {
                GuideCard(
                    ...
                    lines = listOf(
                        ...
                        "طلب و بدهیِ اشخاص: اطلاعات پایه ← خیاط / ناظر / خریدار / کارکنان ← آیکنِ کیفِ پول کنارِ هر نام ← «حساب قبلی». می‌پرسد او از شما طلبکار است یا شما از او.",
            ...
            item {
                GuideCard(
                    ...
                    lines = listOf(
                        ...
                        "لوگو را با دکمهٔ «لوگو» از گالری انتخاب کنید؛ از وسط مربع می‌شود، پس عکسِ کشیده هم بدشکل نمی‌شود."
                    )
                )
            }
